...
/**
 * Class _pdi_paywall_Wp_Plugins_V4
 */
class _pdi_paywall_Wp_Plugins_V4 {
	...
	public function parent_plugins_loaded() {
		...
		if ( ! has_action( '_pdi_paywall_side_info_column' ) ) {
			$this->hook( '_pdi_paywall_side_info_column', 'donate_box', 1 );
			$this->hook( '_pdi_paywall_side_info_column', 'feed_box' );
		}
	}
...
} // End of class _pdi_paywall_Wp_Plugins.
